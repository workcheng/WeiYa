...
(function ($) {
    ...
    $.fn.barrager = function (barrage) {
        ...
        var div_barrager_box = $("<div class='barrage_box'></div>").appendTo(div_barrager);
        if (barrage.img) {
        ...
        var content = $("<div class='user-content' title='" + barrage.info + "' style='border: 4px solid #0099CC;color:#0099CC;'></div>").appendTo(id + " .barrage_box");
        content.attr({
            'href': barrage.href,
            'id': barrage.id
        ...
        if (navigator.userAgent.indexOf("MSIE 6.0") > 0 || navigator.userAgent.indexOf("MSIE 7.0") > 0 || navigator.userAgent.indexOf("MSIE 8.0") > 0) {
            ...
            content.css('border', '2px solid ' + barrage.color);
